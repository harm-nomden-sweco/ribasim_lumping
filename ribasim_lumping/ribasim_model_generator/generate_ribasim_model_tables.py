...
def generate_tabulated_rating_curve(basins_outflows, tabulated_rating_curves, basin_h, \
...
def generate_boundary_time_table(boundaries, boundaries_csv_data, boundarytype):
